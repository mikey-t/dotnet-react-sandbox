...
import { whichSync, isPlatformWindows, isPlatformLinux, isPlatformMac, spawnAsync, isDockerRunning } from '@mikeyt23/node-cli-utils'
import * as net from 'net'

type PlatformCode = 'win' | 'linux' | 'mac'
